...
#configurasi sslh
wget -O /etc/default/sslh "https://raw.githubusercontent.com/Me-D00/Leader_debian_vps/master/sslh-conf"
...
#mkdir build
#cd /usr/bin/build
#wget https://github.com/Me-D00/Leader_debian_vps/raw/master/badvpn/badvpn-update.zip
#unzip badvpn-update
